      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="/estatuto">Estatutos</a>
            <a class="collapse-item" href="/cen-cud">Cen-Cud</a>
          </div>
        </div>
      </li>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Base de Datos</h1>
              ...
              <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Solicitud Pendiente</div>
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  ...
                  <div class="dropdown no-arrow">
                    ...
                    <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
                      ...
                      <a class="dropdown-item" href="#">Directo</a>
          ...
          <div class="row">
            ...
            <div class="col-lg-6 mb-4">
               ...
               <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  <p> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Excepturi dolorum molestias itaque, atque incidunt, nostrum accusamus nobis quis maiores repellendus impedit rem velit cupiditate a laboriosam sed omnis cum? Fugit.
                </div>
              </div>
            ...
            <div class="col-lg-6 mb-4">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <div class="text-center">
                    <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;" src="img/info.png"  height="30px">
                  </div>
                  <p> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Excepturi dolorum molestias itaque, atque incidunt, nostrum accusamus nobis quis maiores repellendus impedit rem velit cupiditate a laboriosam sed omnis cum? Fugit.
                </div>
              </div>
